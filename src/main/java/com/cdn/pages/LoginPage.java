...
public class LoginPage extends BaseClass{
	...
	//@AndroidFindBy(id="//android.widget.ListView/android.widget.FrameLayout[1]/android.widget.TextView") private MobileElement existingSubscriptionLink; 
	...
	//@AndroidFindBy (xpath = "//android.widget.RelativeLayout/android.view.ViewGroup/android.widget.TextView") private MobileElement loginPageHeader;
